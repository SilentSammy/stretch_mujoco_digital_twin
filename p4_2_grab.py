...
def main():
    ...
    try:
        while True:
            ...
            if phase == "navigate":
                command.update(navigation_stow.get_command())
                    ...
                    if center and not grabbed:
                        ...
                        if gripper_ready:
                            ...
                            if distance is not None:
                                ...
                                command["arm_out"] = centered * np.clip( KP_ARM * (distance - TARGET_WRIST_DISTANCE), -1.0, 1.0)
                                if ( center_error <= WRIST_CENTER_TOLERANCE
